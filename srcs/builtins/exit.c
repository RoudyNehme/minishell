...
/*   Updated: 2025/12/18 23:39:25 by rberdkan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    ft_putendl_fd("bash: exit: too many arguments", 2);  // ← CHANGE PREFIX
...
static void	handle_invalid_number(char *arg, t_shell *shell,
                                    t_cleanup_data *data)
{
    ft_putstr_fd("bash: exit: ", 2);      // ← CHANGE PREFIX
    ft_putstr_fd(arg, 2);
